...
const ForMen = () => {
  ...
  //fetch list of product for men
  useEffect(() => {
    dispatch(fetchAllFilteredProducts("men"));
  }, [dispatch]);

  return (
    <div className='bg-black h-auto  flex flex-col justify-center  w-full'>
        <div className='p-7'>
            <img src="https://res.cloudinary.com/dtlejpoxq/image/upload/v1730560301/Mern-Ecommerce/Frame_1000004438_c0smkf.png" alt="" />
        </div>

        {/* This is the list of all the product */}
