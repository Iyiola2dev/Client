    ...
    <div>
      <Card className="bg-black border-[#797979]">
        <CardContent className="grid gap-4 p-4 border-[#797979] text-white">
          ...
          <Label className="border-b border-[#797979] py-2">Email: {addressInfo.email}</Label>
          <Label className="border-b border-[#797979] py-2">
          ...
          <Label className="border-b border-[#797979] py-2">Region: {addressInfo.region}</Label>
        </CardContent>
